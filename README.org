...
* CAT Interface
There is a rudimentary CAT (computer aided transceiver) interface in Hamlib.
Currently, the Yaesu FT-891 is supported.
...
You can check out Ham.CAT.YaesuFT891 for an example how it is currently done for the Yaesu FT-891.
